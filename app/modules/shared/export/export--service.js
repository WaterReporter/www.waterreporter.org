        ...
        geojsonToCsv: function (geoJsonObject) {
          ...
          angular.forEach(geoJsonObject.features, function(feature) {
            ...
            var row = [
              ...
              ((feature.properties.owner && feature.properties.owner.properties.title) ? feature.properties.owner.properties.title.replace(/ /g, '%20') : ''),
              ((feature.properties.owner && feature.properties.owner.properties.organization_name) ? feature.properties.owner.properties.organization_name.replace(/ /g, '%20') : ''),
